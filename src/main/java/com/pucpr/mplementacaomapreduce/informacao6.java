...
public class informacao6 {
    public static class MapperImplementacao6 extends Mapper<Object,Text,Text, IntWritable >{
        public void map(Object chave,Text valor,Context context) throws IOException, InterruptedException{
            //4.mercadoria com a maior quantidade de transações finaceiras em 2016 no Brazil
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        String arquivoSaida="/home2/ead2021/SEM1/adilson.reis/Desktop/implementacaoLocalMR/informacao6";
        if(args.length==2){
